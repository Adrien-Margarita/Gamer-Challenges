...
export const createParticipationVote = async (req: Request, res: Response, next: NextFunction) => {
...
export const getAllParticipationVotes = async (req: Request, res: Response, next: NextFunction) => {
  try {
...
export const getAllParticipationVotesByParticipationId = async (req: Request, res: Response, next: NextFunction) => {
...
export const deleteParticipationVote = async (req: Request, res: Response, next: NextFunction) => {
